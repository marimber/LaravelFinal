...
<div class="container">
    ...
    @endif
        ...
        @csrf
            ...
            <button onClick="alert('¡Actualizacion exitosa!')" type="submit" class="btn btn-success col-md">Editar</button><br/>

            
            <br/><a onClick="return confirm('¿Estas seguro?');"  href="{{ route('userdestroy') }}" class="btn btn-danger col-md">{{ __('Eliminar') }}
            </a>
        </form>
    </div>
</div>
